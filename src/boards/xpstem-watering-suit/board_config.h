...
#define SOIL_MOISTURE_PIN                   GPIO_NUM_27
#define MANUAL_BUTTON_PIN                   GPIO_NUM_26
#define PUMP_CONTROL_PIN                    GPIO_NUM_15
#define PUMP_CONTROL_OUPUT_INVERT           false
